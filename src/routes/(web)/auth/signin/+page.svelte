<script lang="ts">
  ...
  import { PUBLIC_APP_NAME } from '$env/static/public';
	...
	let disableSubmit = $derived(!email || !password);
</script>
...
>
	<div class="flex w-full flex-col gap-6">
		<div class="card overflow-hidden rounded-lg bg-base-200 p-0 shadow-xl">
        ...
        <form method="POST" use:enhance={createEnhanceHook({
				...
				<div class="flex flex-col gap-4 p-5 lg:p-10">
					<div class="flex flex-col items-center text-center">
						<h1 class="text-2xl font-bold">Welcome back</h1>
						<p class="text-balance text-base-content/70">
							Sign in to your <span class="font-semibold">{PUBLIC_APP_NAME}</span> account
						</p>
					</div>
              ...
              bind:value={email}
					...
					<div class="grid gap-3">
						<div class="flex items-center">
							...
							<a href="##" tabindex={-1} class="ml-auto text-sm underline-offset-2 hover:underline">
                ...
                bind:value={password}
					...
					<div class="divider text-sm text-base-content/70">OR CONTINUE WITH</div>
					...
					<div class="text-center text-sm">
						...
						<a href="##" class="link link-primary underline-offset-4"> Sign up </a>
					</div>
				</div>
        </form>
		...
		<div class="text-center text-xs text-balance text-base-content/70">
			By clicking continue, you agree to our <a href="##" class="link link-primary"
				>Terms of Service</a
			>
