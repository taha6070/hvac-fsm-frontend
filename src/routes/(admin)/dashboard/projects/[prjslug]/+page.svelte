...
<div class="mt-5">
<button class="btn btn-primary" on:click={() => goto(`/dashboard/projects/${projectId}/helperjobs/`)}>
Technician Jobs
</button>

<button class="btn btn-primary" on:click={() => goto(`/dashboard/projects/${projectId}/jobs/create`)}>
  Create Job
</button>

<button class="btn btn-primary" on:click={() => goto(`/dashboard/projects/${projectId}/pays`)}>
  Show Pays
</button>

<button class="btn btn-primary" on:click={() => goto(`/dashboard/projects/${projectId}/fixed-pays`)}>
  Show Fixed Pays
</button>
    ...
    <div class="card-body">
      ...
      <div class="overflow-x-auto mt-4">
        <table class="table table-zebra">
          ...
          <td>
            <a href="/jobs/{job.job_slug}">View Job</a>
          </td>
