<script lang="ts">
  ...
  import { ArrowLeft, MapPin, Calendar, User, Briefcase } from "@lucide/svelte";
...
<div class="mb-6 flex items-center gap-4">
  ...
  <div>
    <h1 class="text-3xl font-bold text-base-content">Create Technician Job</h1>
    <p class="text-sm text-base-content/60 mt-1">Assign a new helper/technician role to the project</p>
  </div>
</div>
  ...
  <div class="card bg-base-100 shadow-xl border border-base-200 h-fit">
    <div class="card-body">
      ...
      <ul class="list-disc list-inside text-sm text-base-content/80 space-y-2">
        <li>A Technician/Helper Job must be assigned to an employee.</li>
        <li>Ensure the correct Job Type is selected from the dropdown so standard pay rates can apply.</li>
        <li>Start dates indicate when the technician should be on site.</li>
      </ul>
        ...
        <div class="bg-primary/10 rounded-xl p-4 border border-primary/20">
          <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col">
              <span class="font-bold text-base-content text-sm">Selected Technician</span>
      ...
      {:else}
        <div class="alert mt-2 py-3 px-3 rounded-lg text-sm bg-base-200 border-none flex flex-row items-center gap-3">
          ...
          <span>No employee selected yet. Ensure you assign a Technician before submitting.</span>
        </div>
      {/if}
    </div>
  </div>
