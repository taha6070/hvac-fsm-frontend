...
<div class="mb-6 flex items-center gap-4">
  ...
  <div>
    ...
    <p class="text-sm text-base-content/60 mt-1">
      Assign a new helper/technician role to the project
    </p>
  </div>
</div>
    ...
    <div class="card-body">
      ...
      {:else}
        ...
        >
          ...
          <span
            >No employee selected yet. Ensure you assign a Technician before
            submitting.</span
          >
        </div>
      {/if}
