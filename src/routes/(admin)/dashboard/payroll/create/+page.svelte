<script lang="ts">
  ...
  $: if (typeof amount === "string" && /[^\d.]/.test(amount)) {
    amountError =
      "Currency symbols are not allowed. Symbols were automatically removed.";
...
<div class="mb-6 flex items-center gap-4">
  <button
    ...
    on:click={() => goto("/dashboard/payroll")}
  >
  ...
  <div>
    ...
    <p class="text-sm text-base-content/60 mt-1">
      Define payment and commission structures for employees
    </p>
  </div>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="form-control w-full relative">
            <label class="label" for="employeeSearch">
              <span class="label-text font-medium text-base-content/80"
                >Employee <span class="text-error">*</span></span
              >
            </label>
            <div class="relative">
              <div
            ...
            {#if employee.length}
              <div
                class="absolute top-20 z-10 bg-base-100 shadow-xl rounded-xl w-full border border-base-300 max-h-60 overflow-auto"
              >
          ...
          <div class="form-control w-full relative">
            <label class="label" for="jobTypeSearch">
              <span class="label-text font-medium text-base-content/80"
                >Job Type <span class="text-error">*</span></span
              >
            </label>
            <div class="relative">
              <div
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="form-control w-full">
            <label class="label" for="baseAmount">
              <span class="label-text font-medium text-base-content/80"
                >Base Amount <span class="text-error">*</span></span
              >
            ...
            <div class="relative">
              ...
              <input
                ...
                type="text"
                inputmode="decimal"
                class="input input-bordered w-full pl-10 focus:input-primary transition-all {amountError
                  ? 'input-error'
                  : ''}"
                placeholder="e.g. 500"
                bind:value={amount}
          ...
          <div class="form-control w-full">
            ...
            <div class="relative">
              ...
              <select
                ...
                name="commission"
                class="select select-bordered w-full pl-10 focus:select-primary transition-all"
              >
                <option value="" disabled selected hidden
                  >Will this apply?</option
                >
          ...
          <div class="form-control w-full">
            ...
            <div class="relative">
              ...
              <select
                id="helperDeduction"
                bind:value={helper_deduction}
                name="helper_deduction"
                class="select select-bordered w-full pl-10 focus:select-primary transition-all"
              >
                <option value="" disabled selected hidden
                  >Will this apply?</option
  ...
  <div class="card bg-base-100 shadow-xl border border-base-200 h-fit">
    <div class="card-body">
      ...
      <ul class="list-disc list-inside text-sm text-base-content/80 space-y-2">
        <li>
          A payroll rule links a <strong>Job Type</strong> to a specific
          <strong>Employee</strong>'s pay rate.
        </li>
        <li>
          The <strong>Base Amount</strong> is flat pay. Do not include currency symbols.
        </li>
        <li>
          <strong>Commission</strong> is a percentage-based bonus paid on top of
          the base amount. Leave empty if none applies.
        </li>
        <li>
          <strong>Helper Deduction</strong> automatically subtracts a portion of
          the pay if a helper is assigned to assist the employee on the job.
        </li>
      </ul>
